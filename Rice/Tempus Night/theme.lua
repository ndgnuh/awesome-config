...
theme.link = "#7BAAF7"
theme.positive = "#67BB8A"
theme.negative = "#E67C73"
theme.warning = "#F7CB4D"
-- those color use webstuff, not really using it anyone
...
theme.notification_shape = function(cr, w, h)
    return gears_shape.partially_rounded_rect(
        cr, w, h, false, false, false, true)
end
