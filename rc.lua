...
tile_layout.name = "田"
awful.layout.suit.floating.name = "鳥"
max_layout.name = "大"
...
local function set_wallpaper(s)
    -- Wallpaper
    local wallpaper = gears.filesystem.get_configuration_dir() .. "/wallpaper"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- awful.tag({ "一", "に", "三", "よ", "ご" }, s, awful.layout.layouts[1])
    -- awful.tag({ "一", "二", "三", "し", "ご", "六", "七" }, s, awful.layout.layouts[1])
    -- awful.tag({ "はる", "なつ", "あき", "に" }, s, awful.layout.layouts[1])
            ...
            taglist.setup(s, "vertical"),
            {
                ...
                buttons = awful.button({}, 1, function() awful.spawn.raise_or_spawn("Thunar") end),
                {
                    ...
                    margins = 8,
                    {
                        ...
                        image = gears.filesystem.get_configuration_dir() .. "icons8-folder-96.png",
                    },
                },
            },
        },
