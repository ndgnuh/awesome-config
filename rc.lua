...
local menu_awesome = { "awesome", menu, beautiful.awesome_icon }
...
local function span_client(c, cw, ch)
    ...
    local right_most, left_most, top_most, bottom_most -- luacheck: no unused
...
local function set_wallpaper(s)
    -- Wallpaper
    local wallpaper = lib.resource("assets/wallpaper.png")
...
local globalkeys = gears.table.join(
    ...
    awful.key(mod, "m", function()
        awful.layout.set(workflow.layout.max)
    ...
    awful.key(mod, "t", function()
        awful.layout.set(workflow.layout.tile)
    ...
    awful.key(mod_shift, "r", capi.awesome.restart, { description = "reload awesome", group = "awesome" }),
    awful.key(mod_shift, "q", capi.awesome.quit, { description = "quit awesome", group = "awesome" }),
